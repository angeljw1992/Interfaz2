        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("profile.password.update") }}">
                    @csrf
                    <div class="form-group mb-2">
                        <label class="form-label required" for="password">New {{ trans('cruds.user.fields.password') }}</label>
                    ...
                    <div class="form-group mb-2">
                        <label class="form-label required" for="password_confirmation">Repeat New {{ trans('cruds.user.fields.password') }}</label>
